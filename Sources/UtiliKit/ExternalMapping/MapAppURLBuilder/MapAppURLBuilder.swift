...
public protocol MapAppURLBuilder {
    ...
    ///   - zoomPercent: A percent as decimal value in the range of `0.0...1.0` to specify how far to zoom in on the map.
...
extension MapAppURLBuilder {
    ...
    /// - Parameter percent: `0.0...1.0` percent as decimal value
    ...
    static func zoomValue(fromPercent percent: Float?) -> Float? {
        ...
        return (percent * (zoomRange.upperBound - zoomRange.lowerBound)) + zoomRange.lowerBound
    }
}
